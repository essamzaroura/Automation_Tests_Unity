...
public class ApiTest {
    ...
    public void setUp() {
        ...
        if (!(statusCode == 302 || statusCode == 200)) {
            throw new RuntimeException(
                    "Login failed with status: " + statusCode + ". Response: " + loginResponse.asString());
        }
    ...
    public void testPostStatusChange() {
        ...
        String uniqueEmail = "TestPublisher_API_" + UUID.randomUUID().toString().substring(0, 8) + "@hotmail.com";
